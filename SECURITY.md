...
Thank you for using or contributing to **actix-firebase-auth**. Ensuring the security of our project and its users is a top priority.
...
This security policy applies to the **actix-firebase-auth** project. Security issues in our dependencies or related projects should be reported to their maintainers.
...
We appreciate your cooperation in helping keep **actix-firebase-auth** secure for everyone.
